...
export function PublishProject({ organizationId }: { organizationId: string }) {
  ...
  const { isPending, mutate } = useMutation({
    mutationFn: async (data: z.infer<typeof FormSchema>) => {
      const response = await fetch(`/api/publishProject/${organizationId}`, {
        method: 'POST',
        headers: {
